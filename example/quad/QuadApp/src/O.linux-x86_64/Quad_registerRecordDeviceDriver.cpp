...
/* Generated from ../O.Common/Quad.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_tsInitialize, pvar_func_register_func_mySubInit,
...
int Quad_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/niklas/git/rust-in-epics/example/quad";
...
/* Quad_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"Quad_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    Quad_registerRecordDeviceDriver(*iocshPpdbbase);
}
